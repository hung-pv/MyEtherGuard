...
public class KeystoreManager {
	...
	public static void save(KeystoreContent keystore) throws Exception {
		keystore.setAdditionalInformation(String.format("Generated by %s", App.getAdditionalDetailInformation()));
		UniqueFileUtils.write(FILE_AES_KEYSTORE, keystore.toString());
	}
